...
Rcpp::XPtr<QuantLib::Calendar> getCalendar(const std::string &calstr) {
    ...
    if (calstr == "TARGET") { 		// generic calendar
        ...
        pcal = new QuantLib::Austria();
    } else if (calstr == "Austria/Exchange") {
        pcal = new QuantLib::Austria(QuantLib::Austria::Exchange);
#endif

    } else if (calstr == "Bespoke") {
        pcal = new QuantLib::BespokeCalendar();

    } else if (calstr == "Botswana") {
        pcal = new QuantLib::Botswana();
        ...
        pcal = new QuantLib::France(QuantLib::France::Settlement);
    } else if (calstr == "France/Exchange") {
        pcal = new QuantLib::France(QuantLib::France::Exchange);
        ...
        pcal = new QuantLib::Israel(QuantLib::Israel::Settlement);
    } else if (calstr == "Israel/TASE") {
        pcal = new QuantLib::Israel(QuantLib::Israel::TASE);
        ...
        pcal = new QuantLib::Romania(QuantLib::Romania::Public);
    } else if (calstr == "Romania/BVB") {
        pcal = new QuantLib::Romania(QuantLib::Romania::BVB);
#endif
        ...
        pcal = new QuantLib::UnitedStates(QuantLib::UnitedStates::LiborImpact);
    } else if (calstr == "UnitedStates/FederalReserve") {
        pcal = new QuantLib::UnitedStates(QuantLib::UnitedStates::FederalReserve);
