    ...
    if (interpWhat == "discount"  && interpHow == "linear" ) {
        ts = new QuantLib::PiecewiseYieldCurve<QuantLib::Discount,
                                               QuantLib::Linear>(
                                                   ...
                                                   curveInput,
                                                   dayCounter,
                                                   QuantLib::PiecewiseYieldCurve<QuantLib::Discount, QuantLib::Linear>::bootstrap_type(tolerance));
        ...
        ts = new QuantLib::PiecewiseYieldCurve<QuantLib::Discount,
                                               QuantLib::LogLinear>(
                                                   ...
                                                   curveInput,
                                                   dayCounter,
                                                   QuantLib::PiecewiseYieldCurve<QuantLib::Discount, QuantLib::LogLinear>::bootstrap_type(tolerance));
        ...
        ts = new QuantLib::PiecewiseYieldCurve<QuantLib::Discount,
                                               QuantLib::Cubic>(
                                                   ...
                                                   curveInput,
                                                   dayCounter,
                                                   QuantLib::PiecewiseYieldCurve<QuantLib::Discount, QuantLib::Cubic>::bootstrap_type(tolerance));
        ...
        ts = new QuantLib::PiecewiseYieldCurve<QuantLib::ForwardRate,
                                               QuantLib::Linear>(
                                                   ...
                                                   curveInput,
                                                   dayCounter,
                                                   QuantLib::PiecewiseYieldCurve<QuantLib::ForwardRate, QuantLib::Linear>::bootstrap_type(tolerance));
        ...
        ts = new QuantLib::PiecewiseYieldCurve<QuantLib::ForwardRate,
                                               QuantLib::LogLinear>(
                                                   ...
                                                   curveInput,
                                                   dayCounter,
                                                   QuantLib::PiecewiseYieldCurve<QuantLib::ForwardRate, QuantLib::LogLinear>::bootstrap_type(tolerance));
        ...
        ts = new QuantLib::PiecewiseYieldCurve<QuantLib::ForwardRate,
                                               QuantLib::Cubic>(
                                                   ...
                                                   curveInput,
                                                   dayCounter,
                                                   QuantLib::PiecewiseYieldCurve<QuantLib::ForwardRate, QuantLib::Cubic>::bootstrap_type(tolerance));
        ...
        ts = new QuantLib::PiecewiseYieldCurve<QuantLib::ZeroYield,
                                              QuantLib::Linear>(
                                                  ...
                                                  curveInput,
                                                  dayCounter,
                                                  QuantLib::PiecewiseYieldCurve<QuantLib::ZeroYield, QuantLib::Linear>::bootstrap_type(tolerance));
        ...
        ts = new QuantLib::PiecewiseYieldCurve<QuantLib::ZeroYield,
                                               QuantLib::LogLinear>(
                                                   ...
                                                   curveInput,
                                                   dayCounter,
                                                   QuantLib::PiecewiseYieldCurve<QuantLib::ZeroYield, QuantLib::LogLinear>::bootstrap_type(tolerance));
        ...
        ts = new QuantLib::PiecewiseYieldCurve<QuantLib::ZeroYield,
                                               QuantLib::Cubic>(
                                                   ...
                                                   curveInput,
                                                   dayCounter,
                                                   QuantLib::PiecewiseYieldCurve<QuantLib::ZeroYield, QuantLib::Cubic>::bootstrap_type(tolerance));
    } else {
